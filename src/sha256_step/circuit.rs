use bellperson::{
    gadgets::{num::AllocatedNum, uint32::UInt32, multipack::pack_bits, boolean::AllocatedBit},
    gadgets::{multipack::bytes_to_bits, boolean::Boolean},
    ConstraintSystem, SynthesisError,
};
use nova_snark::traits::circuit::StepCircuit;
use pasta_curves::group::ff::{PrimeField, PrimeFieldBits};
use crate::sha256::sha256_compression_function;
use super::util::{sha256_state_sequence, BLOCK_LENGTH_BYTES, DIGEST_LENGTH_BYTES, digest_to_scalars};
